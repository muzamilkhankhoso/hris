...
//    public function approveAndRejectRequestHiring()
//    {
//        CommonHelper::companyDatabaseConnection(Input::get('companyId'));
//        DB::update('update requesthiring set ApprovalStatus = ? where id = ?',[Input::get('approval_status'),Input::get('recordId')]);
//        CommonHelper::reconnectMasterDatabase();
//        Session::flash('dataEdit','successfully Updated.');
//
//    }
...
//    }
    ...
    public function deleteEmployee()
    {
        ...
        $log['activity_id']        = Input::get('recordId');
        ...
        CommonHelper::reconnectMasterDatabase();
        //DB::table('users')->where([['emp_id','=',Input::get('emp_id')]])->delete();
    ...
    public function approveAndRejectLeaveApplication3()
    {
        DB::table('leave_application')
            ->where('id',Input::get('recordId'))
            ->update(['approval_status_hd' => 2,'approval_status_hd_name' => Auth::user()->name]);
        Session::flash('dataDelete','successfully Updated.');
    }
