...
function viewRangeWiseLeaveApplicationsRequests()
{
    ...
    if(validate == 0) {
        ...
        data = {employee_id:employee_id,pending:pending,from_date:from_date,to_date:to_date,rejected:rejected,approved:approved,m:m,company_id:company_id,department_id:department_id,sub_department_id_1:sub_department_id_1}
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#employeeAttendenceReportSection').css({'display':'block'});
                $('#leavesLoader').html("");
                $('.employeeAttendenceReportSection').html(data);
