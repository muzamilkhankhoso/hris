...
function viewAttendanceProgress(){
    ...
    if ($("#show_all").is(":checked")) {
        var data = {show_all:show_all,month_year:month_year,m:m,employee_id:employee_id,department_id:department_id,from_date:from_date,to_date:to_date,sub_department_id:sub_department_id,emp_status:emp_status}
    }
    else{
        var data = {month_year:month_year,m:m,employee_id:employee_id,department_id:department_id,from_date:from_date,to_date:to_date,sub_department_id:sub_department_id,emp_status:emp_status}
    }
...
function attendanceProgressFilteredList() {
    ...
    if(validate == 0) {
        ...
        $("#attendance_progress_list").css({"display": "block"});
    }else{
        return false;
    }
}
