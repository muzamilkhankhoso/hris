...
function removeDependsSection(id){
    $("#remove_area_"+id).remove();
}
function removeNomineeBehalfSection(id){
    $("#remove_area_"+id).remove();
}
...
$('#reference_check_1').click(function(){
    ...
    if($(this).is(":checked") == true)
    {
        $("#reference_area_1").html('<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 get_rows2"><div class="">' +
            ...
            '<input class="form-control requiredField" name="reference_name_1" id="reference_name_1" >' +
            '</td> </thead><thead> <th>Designation<span class="rflabelsteric"><strong>*</strong></span></th>' +
            '<td class="text-center"><input class="form-control" name="reference_designation_1" id="reference_designation_1">' +
            '</td> </thead> <thead><th>Age</th><td class="text-center">' +
            '<input class="form-control" name="reference_age_1" id="reference_age_1">' +
            '</td></thead><thead>' +
            '<th>Contact Number<span class="rflabelsteric"><strong>*</strong></span></th>' +
            '<td class="text-center"><input class="form-control" type="text" name="reference_contact_1"  id="reference_contact_1">' +
            '</td></thead><thead><th>Relationship</th>' +
            '<td class="text-center"><input class="form-control" name="reference_relationship_1" id="reference_relationship_1"></td>' +
        ...
        $("#addMoreReference").click(function(e){
            ...
            $("#insert_clone2").append('<table class="table table-bordered sf-table-list remove_area2_'+form_rows_count+' get_rows2" id=""><thead>' +
                ...
                '</td> </thead><thead> <th>Designation</th>' +
                '<td class="text-center"><input class="form-control" name="reference_designation_'+form_rows_count+'" id="reference_designation_'+form_rows_count+'" >' +
                '</td> </thead> <thead><th>Age<span class="rflabelsteric"><strong>*</strong></span></th><td class="text-center">' +
                '<input class="form-control" name="reference_age_'+form_rows_count+'" id="reference_age_'+form_rows_count+'" >' +
                '</td></thead><thead><th>Contact Number</th>' +
                '<td class="text-center"><input class="form-control" type="text" name="reference_contact_'+form_rows_count+'"  id="reference_contact_'+form_rows_count+'" >' +
                '</td></thead><thead><th>Relationship</th>' +
                '<td class="text-center"><input class="form-control" name="reference_relationship_'+form_rows_count+'" id="reference_relationship_'+form_rows_count+'"></td>' +
                '</thead></table>' +
