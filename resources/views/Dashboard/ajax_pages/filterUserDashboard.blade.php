...
if($promoted_designation->count() > 0):
    ...
    $designation_id= $promoted_designation->value('designation_id');
else:
    $emp_designation_id = $employee->value('designation_id');
    $designation_id=$employee->value('designation_id');
endif;
...
<div class="row">
    ...
    <div class="col-sm-12">&nbsp;
        <div class="text-center">
            ...
            <pre><?php echo HrHelper::getMasterTableValueById(Input::get('m'),'sub_department','sub_department_name',$employee->value('emp_sub_department_id')); ?> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <?php echo HrHelper::getMasterTableValueById(Input::get('m'),'designation','designation_name',$designation_id)?></pre>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="card card-nav-tabs card-plain">
            ...
            <div class="card-header card-header-danger" id="user_menu_tabs" style="padding-left: 7% !important;font-size:15px !important;">
                ...
                <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                        <ul class="nav nav-tabs" data-tabs="tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#WorkExperience" data-toggle="tab">Work Experience</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" target="_blank" href="https://playbook.hr-innovative.com/" >HR playbook</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="tab-content container-fluid">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                    ...
                                    <div class="btn-group" data-toggle="buttons" style="padding: 4px;">
                                        @foreach($leaves_policy as $val)
                                            ...
                                            <label style="cursor:pointer; border:1px solid #fff;color:white;" @if($val->leave_type_id=="1") class="btn btn-sm btn-success" @else class="btn btn-sm btn-warning" @endif onclick="viewEmployeeLeavesDetail('<?=$val->id?>','{{ $val->no_of_leaves }}','<?php echo $val->leave_type_id ?>')">
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="table-responsive LeavesData">
                                                                    ...
                                                                    <table class="table table-sm mb-0 table-bordered table-striped table-hover" id="LeaveApplicationRequestList">
                                                                                    ...
                                                                                    <div class="dropdown">
                                                                                        ...
                                                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                                                                            ...
                                                                                            @if($value->approval_status != 2 && $value->approval_status_lm != 2)
                                                                                                ...
                                                                                                @elseif(($value->status == 1 || $value->status == 5) && ($value->approval_status != 2 && $value->approval_status_lm != 2))
                                                                        ...
                                                                        <?php } else { ?>
                                                                        <tr>
                                                                            <td colspan="12" class="text-center text-danger"><strong>No Reord Found</strong></td>
                                                                        </tr>
                                                                        <?php } ?>
                                                                        </tbody>
                                                                    </table>
                ...
                <div class="tab-pane fade in" id="WorkExperience">
                    <br>
                    ...
                    <div class="row">
                        ...
                        <table class="table table-sm mb-0 table-bordered table-striped table-fixed">
                            ...
                            <?php if(count($employee_work_experience) != 0){ ?>

                            <?php foreach($employee_work_experience as $value){ ?>
                            <?php $url=url('/').Storage::url($value->work_exp_path); ?>
                            <tr>
                                <td class="text-center"><?php echo $counter++ ?></td>
                                <td class="text-center"><?php echo $value->employeer_name ?></td>
                                <td class="text-center"><?php echo $value->started ?></td>
                                <td class="text-center"><?php echo $value->ended ?></td>
                                <td class="text-center">
                                    @if($value->work_exp_path != null)
                                        <div class="row text-center">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                                <a target="_blank" href="<?=$url?>"style="cursor:pointer;color:white;margin-top:6px;font-size:18px;font-wight:bold;" ><i class="badge badge-info">Download</i></a>
                                            </div>
                                        </div>
                                    @else
                                        --
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <ul class="timeline">
                                ...
                                <li>
                                    ...
                                    <a href="#" class="float-right"><?php echo date("F-d-Y", strtotime($employee->value('emp_joining_date'))) ?></a>
...
//                                $('#response').hide().html('<strong>Successfully Updated !!</strong>').fadeIn('slow').delay(3000).hide(1);
            ...
            $(document).ready(function(){
                ...
                $('#add_work_exp span').html(" Add Work Experience");
            ...
            function leaves_day_type(type)
            {
                ...
                else if(leave_type == 3)
                {
                    ...
                    else if(type == 'half_day_leave')
                    {
                        ...
                        $("#leave_days_area").html('<div class="row"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">' +
                            '<label> (09:00 A.M to 02:00 P.M) &nbsp;&nbsp;&nbsp;First Half&nbsp;:&nbsp;<input type="radio" value="first_half" id="first_second_half" name="first_second_half"></label><br>' +
                            '<label> (01:00 P.M to 06:00 P.M) &nbsp;&nbsp;&nbsp;2nd Half&nbsp;:&nbsp;<input type="radio" value="second_half" id="first_second_half" name="first_second_half"></label></div>' +
                            '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">' +
...
//                $('.leaveAppLoader').html('<div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="loader"></div></div></div>');
            ...
            $('#add_work_exp').click(function(){
                var a=$('#add_work_exp span').html();
                if(a == " Add Work Experience"){
                    $("#add_work_exp .avion").removeClass("fa-plux").fadeIn(1000);
                    $("#add_work_exp").removeClass("btn-success").fadeIn(1000);
                    $("#add_work_exp").addClass("btn-warning").fadeIn(1000);
                    $("#add_work_exp .avion").addClass("fa-times").fadeIn(1000);
                    $("#add_work_exp .avion").html(' Close').fadeIn(1000);
                    $("#institute_name_1").addClass('requiredField');
                    $("#year_of_admission_1").addClass('requiredField');
                    $("#year_of_passing_1").addClass('requiredField');
                    $("#degree_type_1").addClass('requiredField');
                    ...
                    $("#add_work_exp .avion").removeClass("fa-times").fadeIn(1000);
                    $("#add_work_exp").removeClass("btn-warning").fadeIn(1000);
                    $("#add_work_exp").addClass("btn-success").fadeIn(1000);
                    $("#add_work_exp .avion").addClass("fa-plus").fadeIn(1000);
                    $("#add_work_exp .avion").html(' Add Education').fadeIn(1000);
                    $("#institute_name_1").removeClass('requiredField');
                    $("#year_of_admission_1").removeClass('requiredField');
                    $("#year_of_passing_1").removeClass('requiredField');
                    $("#degree_type_1").removeClass('requiredField');
        ...
        <script>
            $(document).ready(function(){
                if (typeof(Storage) !== "undefined") {
                    if(localStorage.getItem("mineLeaves") == "1"){
                        $(".mineLeaves .nav-link").trigger("click");
                        localStorage.removeItem('mineLeaves');
                    }
                    ...
                    $.notify({
                        icon: "fa fa-times-circle",
                        message: "<b>Sorry, your browser does not support Web Storage...</b>."
                    }, {
                        type: 'warning',
                        timer: 3000
                    });
