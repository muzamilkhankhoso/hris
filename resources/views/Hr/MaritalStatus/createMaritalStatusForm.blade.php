        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <h4 class="card-title">Create Marital Status Form</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                            ...
                            {{--<input type="button" class="btn btn-sm btn-primary addMoreMartialStatusSection" value="Add More Marital Status" />--}}
                        </div>
                    </div>
                </div>
