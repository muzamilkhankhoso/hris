                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <button type="button" class="btn btn-sm btn-primary btn_search" id="showAttendenceReport" onclick="showPayrollReport()" style="margin-top: 36px;" ><i id="load" class="fas fa fa-search"> </i> Search</button>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12" >
                                <div id="loader"></div>
                                <span id="regionWisePayrollReport"><div class="employeeAttendenceReportSection" id="PrintEmployeeAttendanceList"></div></span>
                            </div>
                        </div>
