...
$sub_department_name = HrHelper::getMasterTableValueByIdAndColumn($m, 'sub_department', 'sub_department_name', $emp_sub_department_id, 'id');
                            ...
                            <div class="gudia-gap">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input readonly name="emr_no" id="emr_no" type="text" value="{{ $emr_no }}" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <span class="rflabelsteric"><strong>*</strong></span>
                                        <input readonly name="sub_department" id="sub_department" type="text" value="{{ $sub_department_name }}" class="form-control">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <br>
                                        <input @if($signed_by_supervisor=='yes')checked @endif  value="yes" type="radio" name="signed_by_supervisor"> Yes &nbsp &nbsp
                                        <input @if($signed_by_supervisor=='no')checked @endif  value="no" type="radio" name="signed_by_supervisor"> No
                                    </div>
                                </div>
                                ...
                                <span id="new">
                                        <div id="" class="row">
                                            ...
                                            <div class="form-group text-center">
                                                ...
                                                <div class="radio">
                                                    <small><input @if($leaving_type==6)checked @endif  value="6" type="radio" name="leaving_type"></small>
                                                </div>
                                            </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==1)checked @endif value="1" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==2)checked @endif value="2" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
                                           <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==3)checked @endif value="3" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
                                           <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==4)checked @endif value="4" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                                <div class="form-group text-center">
                                                    ...
                                                    <br>
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==5)checked @endif value="5" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                <div class="form-group text-center">
                                                    <small>Branch Closed:</small>
                                                    <div class="radio">
                                                        <small><input @if($leaving_type==7)checked @endif  value="7" type="radio" name="leaving_type"></small>
                                                    </div>
                                                </div>
                                            </div>
