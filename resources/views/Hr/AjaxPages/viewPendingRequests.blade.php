...
<a  href="{{ url('hr/viewEmployeePromotions?m='.Input::get('m')) }}" target="_blank">
    <div class="alert alert-secondary" role="alert" style="color:#383d41;">
        <i class="fa fa-tasks fa-fw" style="color:rgb(240,173,78);color:#ffa500;"></i>
        Promotion Requests
        <span class="badge badge-pill badge-warning" style="font-size: 16px;color: white;"><?=$pomotion?></span>
