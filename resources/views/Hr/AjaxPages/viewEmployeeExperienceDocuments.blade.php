                                            ...
                                            <td class="text-center" colspan="5">
                                                <div class="iframe-loading">
                                                    ...
                                                    @if($value->work_exp_type == 'doc' || $value->work_exp_type == 'docx')
                                                        <iframe height="350" style="width: 100%" src="https://docs.google.com/gview?url=<?=$url?>&embedded=true"></iframe>
                                                    @elseif($value->work_exp_type == 'pdf')
                                                        <embed src="https://drive.google.com/viewerng/viewer?embedded=true&url=<?=$url?>" style="width: 100%" height="350">
                                                    @elseif($value->work_exp_type == 'jpeg' || $value->work_exp_type == 'jpg' || $value->work_exp_type == 'png' ||  $value->work_exp_type == 'gif')
                                                        <img style="width: 100%;" height="350" src="<?=$url?>">
                                                    @endif
